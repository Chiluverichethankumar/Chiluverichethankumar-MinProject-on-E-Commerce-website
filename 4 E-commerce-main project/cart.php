...
<head>
  ...
  <title>Gitam Oline Shopping</title>
...
<div class='cart'>
  ...
  <div class="container">
    <h1 style='float:left; color:black;'>Cart</h1>
...
<div style='color:black' class="text-end">
  ...
  <div class="text-end ">
	...
	<script
		...
		data-name="Gitam Online Shopping"
		data-description="Your Choice Our Voice"
    data-image="../logo11.png"
		data-currency="usd"
...
<?php }else { echo "<p style=color:black;>0 Results <br> No items in a cart</p>"; }
             ?>
