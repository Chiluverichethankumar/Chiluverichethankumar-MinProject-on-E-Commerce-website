...
<p style="color:black;" class='desc'>At Gitam Online Shopping, we are dedicated to providing top-quality repairing services to our valued customers. 
...
<label>Number:- 0891 - 2866424</label>
<label>URL link: <a href="https://www.gitam.edu/">Gitam page</a> </label>
<label>Location: Visakhapatnam, Hyderabad, Bengaluru</label>
...
<div class="order">
<h4>check offers</h4>
<p style='width:80% ; color:#dcaa13'>Please provide the uuid of product that you have bought to check offers on repairing products</p>


<form action="<?php echo $_SERVER['PHP_SELF']; ?>" method="post">
<label style=' color:black' for='uuid'>your product uuid:</label>
