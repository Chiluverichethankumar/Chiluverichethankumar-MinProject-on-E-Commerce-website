  ...
  <div class="navbar-inner">
   ...
   <form style='margin-right:4px' class="form-inline navbar-search" method="post" action="./search.php" id='myForm' >
    ...
    <ul id="topMenu" class="nav pull-right">
	 ...
	 <li class=""><a href="https://www.gitam.edu/contact-us">Contact</a></li>
...
<?php echo $_SESSION['cartItemNum'] ?>
	...
	<li class="">
		  <a href="#login" onclick="elementVisibility()" role="button" data-toggle="modal" style="padding-right:0"><span class="btn btn-large btn-success">Login</span></a>
            ...
            <div id="login" class="modal hide fade in" tabindex="-20" role="dialog" aria-labelledby="login" aria-hidden="false" >
            <div class="container1">
            <button type="button" class="close" data-dismiss="modal" aria-hidden="true" onclick="closeTog()" style=
            "color:azure">X</button>
            <center> <img height="180" width="180"  src="./images/logo1.png" alt=""></center>
            <br>
            <h3 style='color:azure;text-align:center;'>Login</h3>
          
            <form class="form-horizontal loginFrm" action="<?php echo $_SERVER['PHP_SELF']; ?> " method="post">
            <div class="control-group">								
            <center><input type="text" id="inputEmail" name="email" placeholder="Email"></center>
            </div>
            <div class="control-group">
            <center><input type="password" id="inputPassword" name="pwd" placeholder="Password"></center>
            </div>
            <div class="control-group">

            </div>
           <center> <button type="submit" name="signin" class="btn btn-success">Login</button></center>
            </form>		

            <center><button class="btn" data-dismiss="modal" aria-hidden="true" onclick="closeTog()">Close</button></center>
            </div>
