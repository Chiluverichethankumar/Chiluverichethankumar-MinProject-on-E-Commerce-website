...
$conn->query($sql22);
echo "";
echo "<h4 style='text-align:center;position:absolute;top:100px;left:20%;padding:0;border:1px solid black;color:black;'>Products has been Added to your Cart</h4>";
  }
  else{
...
<div class="selected_product"  style=' color:black' >
  <div class="prod-in">
...
<img id='image-pr' src="admin/upload/<?php echo $row11['product_img'] ?>"  alt="product-img">
	...
	<p class="price"><b>Rs.<?php echo $row11['product_price'] ?></b>
